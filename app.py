...
def processar_consultas(df):
    ...
    # Renomear colunas chaves para padronização
...
# ==============================================================================
# RENDERIZAR ORÇAMENTO (Código Resumido para focar na mudança principal)
# ==============================================================================
...
# === NOVA TELA: BENEFITS EFFICIENCY MAP ===
    ...
    qtd_consultas_por_empresa = pd.DataFrame(columns=['Razão Social', 'Total_Consultas']) # Default Vazio
    ...
    if df_consultas is not None and not df_consultas.empty:
        ...
        # Agrega Consultas por Razão Social
    ...
    # Razão entre Consultas e Vidas (Utilização)
